...
"java\bin\java.exe" -Dfile.encoding=UTF-8 -Dlocal.storage.dir="%STORAGE_DIR%" -classpath %CLASSPATH% -Xms300m -Xmx500m org.aion.wallet.WalletApplication 2>&1 > "%LOG_DIR%\log_%LOG_FILE_SUFFIX%"